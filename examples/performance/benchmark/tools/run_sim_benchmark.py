...
SCENE_DIR = ROOT / "examples" / "performance" / "benchmark" / "scenes"
RUN_SCENE = ROOT / "tools" / "sim" / "run_scene.sh"
CASE_MANIFEST = ROOT / "examples" / "performance" / "benchmark" / "main" / "bench_cases.inc"
...
def run_case(size: int, args: argparse.Namespace) -> tuple[int, float]:
    ...
    env["GSP_SIM_APPLICATION_SOURCE"] = ";".join((
        str(ROOT / "examples" / "performance" / "benchmark" / "tools" /
            "benchmark_sim_workload.c"),
        str(ROOT / "examples" / "performance" / "benchmark" / "main" /
            "bench_workload.c"),
    ))
