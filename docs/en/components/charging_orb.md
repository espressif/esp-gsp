...
gspc pack \
  examples/usage/widgets/charging_orb/charging_orb.json \
...
This is `examples/usage/widgets/charging_orb/charging_orb.json`. Copy any relative assets referenced by the scene with it.
