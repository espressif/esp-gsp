...
gspc pack \
  examples/usage/widgets/flip_card/flip_card.json \
...
This is `examples/usage/widgets/flip_card/flip_card.json`. Copy any relative assets referenced by the scene with it.
