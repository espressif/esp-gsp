...
gspc pack \
  examples/usage/widgets/toggle/toggle.json \
  --deployable -o gsp-out/widget-preview/toggle.gspb
gsp_sim_host \
  --bundle gsp-out/widget-preview/toggle.gspb
```
...
This is `examples/usage/widgets/toggle/toggle.json`. Copy any relative assets referenced by the scene with it.
...
esp_err_t gsp_widget_toggle_wifi_get_color(esp_gsp_handle_t gsp, uint32_t *out_native_color)
esp_err_t gsp_widget_toggle_wifi_get_effective_visible(esp_gsp_handle_t gsp, bool *out_visible)
...
esp_err_t gsp_widget_toggle_wifi_play_track_color(esp_gsp_handle_t gsp, uint32_t from, uint32_t to, const esp_gsp_animation_config_t *config)
esp_err_t gsp_widget_toggle_wifi_set_checked(esp_gsp_handle_t gsp, bool checked)
esp_err_t gsp_widget_toggle_wifi_set_color(esp_gsp_handle_t gsp, uint32_t native_color)
esp_err_t gsp_widget_toggle_wifi_set_color_rgb888(esp_gsp_handle_t gsp, uint32_t rgb888)
esp_err_t gsp_widget_toggle_wifi_set_track_color(esp_gsp_handle_t gsp, uint32_t new_value)
esp_err_t gsp_widget_toggle_wifi_set_track_color_rgb888(esp_gsp_handle_t gsp, uint32_t rgb888)
esp_err_t gsp_widget_toggle_wifi_set_value(esp_gsp_handle_t gsp, int32_t value)
esp_err_t gsp_widget_toggle_wifi_stop_track_color(esp_gsp_handle_t gsp)
