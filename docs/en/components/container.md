...
Styled parent for grouping, clipping and automatic layout.
...
python -m gsp.execute --version 0.2.8 gspc pack \
  ...
  --deployable -o build/widget-preview/container.gspb
python -m gsp.execute --version 1.1.0 sim \
  --bundle build/widget-preview/container.gspb
```
...
```json
{
  ...
  "objects": [
    ...
    },
    {
      ...
      "w": 326,
      "h": 50,
      "text": "Containers group content, apply layout, clipping and shared styling.",
      "font_size": 15,
      "fg_color": "#9FB0C7"
    },
    {
