# Container (`gsp_container`)

Styled parent with optional rectangular child clipping and automatic layout.
...
gspc pack \
  examples/usage/widgets/container/container.json \
...
```json
{
  ...
  "objects": [
    ...
    },
    {
      ...
      "w": 326,
      "h": 50,
      "text": "Containers group content and layout. clip_children keeps child pixels and input inside the card.",
      "font_size": 15,
      "fg_color": "#9FB0C7"
    },
    {
...
This is `examples/usage/widgets/container/container.json`. Copy any relative assets referenced by the scene with it.
...
| `clip_children` | `bool` | — | default `false` | — | clip descendants and their hit areas to the container bounds |
