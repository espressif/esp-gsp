...
Scrollable single-column picker with optional cyclic selection.
...
This is `examples/widgets/wheel/wheel.json`. Copy any relative assets referenced by the scene with it.
