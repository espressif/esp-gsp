...
gspc pack \
  examples/usage/widgets/clock/clock.json \
  --deployable -o gsp-out/widget-preview/clock.gspb
gsp_sim_host \
  --bundle gsp-out/widget-preview/clock.gspb
```
...
This is `examples/usage/widgets/clock/clock.json`. Copy any relative assets referenced by the scene with it.
...
esp_err_t gsp_widget_clock_local_time_get_effective_visible(esp_gsp_handle_t gsp, bool *out_visible)
...
esp_err_t gsp_widget_clock_local_time_play_hour_angle(esp_gsp_handle_t gsp, int32_t from, int32_t to, const esp_gsp_animation_config_t *config)
esp_err_t gsp_widget_clock_local_time_play_minute_angle(esp_gsp_handle_t gsp, int32_t from, int32_t to, const esp_gsp_animation_config_t *config)
esp_err_t gsp_widget_clock_local_time_play_second_angle(esp_gsp_handle_t gsp, int32_t from, int32_t to, const esp_gsp_animation_config_t *config)
...
esp_err_t gsp_widget_clock_local_time_stop_hour_angle(esp_gsp_handle_t gsp)
esp_err_t gsp_widget_clock_local_time_stop_minute_angle(esp_gsp_handle_t gsp)
esp_err_t gsp_widget_clock_local_time_stop_second_angle(esp_gsp_handle_t gsp)
